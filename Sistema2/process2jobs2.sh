...
#SBATCH -D /export/fhome/maed01/PSIV-Detection-of-Helicobacter-pylori/  # Working directory
...
#SBATCH -o Sistema2/Joblist/%x_%u_%j.out         # File to which STDOUT will be written
#SBATCH -e Sistema2/Joblist/%x_%u_%j.err         # File to which STDERR will be written
...
export PYTHONPATH=/export/fhome/maed01/PSIV-Detection-of-Helicobacter-pylori:$PYTHONPATH

echo "PYTHONPATH: $PYTHONPATH"

# Comprobar que el paquete es visible
python -c "import AutoEncoderMetrics; print('Imported AutoEncoderMetrics OK')" || exit 1

# Ejecutar el Sistema 2
echo "Iniciando entrenamiento del Sistema 2..."
srun python Sistema2/Attention/train_patient_attention.py
