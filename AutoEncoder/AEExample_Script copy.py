...
image_paths = df_cropped["image_path"].tolist()
patient_ids = df_cropped["patient_id"].tolist()

# 1.2 Patches Data
df_annotated = pd.read_csv("Data/HP_WSI-CoordAllAnnotatedPatches_AE.csv")
...
# 2.1 Diagnosis crossvalidation set
